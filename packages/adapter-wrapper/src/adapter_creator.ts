...
import {
  InstanceElement, Adapter, AdapterAuthentication, ActionName,
...
>({
  ...
  operationsCustomizations: {
    ...
    customizeFilterCreators?: (config: Co) => filterUtils.AdapterFilterCreator<
  ...
  return {
    operations: context => {
      ...
      const clients = _.mapValues(initialClients, () => createClient<Credentials>({
        adapterName,
      ...
      const adapterOperations = createAdapterImpl<
        Credentials,
        Co,
        ClientOptions,
        PaginationOptions,
      ...
      >(
        {
          ...
          filterCreators: (
            customizeFilterCreators !== undefined
              ...
              : Object.values(createCommonFilters<
                  definitionUtils.UserConfig,
                  ClientOptions,
                  PaginationOptions,
                  Action
