...
// Also make sure the user is assigned with the right roles
// In general he should be assigned with Global Administrator role to be able to authenticate
export const OAUTH_REQUIRED_SCOPES = [
  'Application.ReadWrite.All',
  // Also the user must also be assigned at least the Attribute Definition Administrator directory role.
  'CustomSecAttributeDefinition.ReadWrite.All',
  'Directory.ReadWrite.All',
  'Group.ReadWrite.All',
  'Policy.Read.All',
  // Also the user must also be assigned at least one of the following roles: Conditional Access Administrator, Security Administrator, Security Reader.
  'Policy.ReadWrite.ConditionalAccess',
  'Policy.ReadWrite.CrossTenantAccess',
  'Policy.ReadWrite.PermissionGrant',
  'RoleManagement.ReadWrite.Directory',
  // Also the user must also be assigned at least one of the following roles: Global Reader, Authentication Administrator, Privileged Authentication Administrator
